    ...
    Scaffold(
        ...
        if(query.isEmpty()) {
            ...
            Column(modifier = Modifier
               ...
               AllSearchItem(title = "Dosa", type = "Dish", R.drawable.dosa)
               AllSearchItem(title = "Masala Dosa", type = "Dish", R.drawable.bg_4)
               AllSearchItem(title = "Sada Dosa", type = "Dish", R.drawable.bg_3)
               AllSearchItem(title = "Mysore Masala Dosa", type = "Dish", R.drawable.bg_2)
               AllSearchItem(title = "Rava Masala Dosa", type = "Dish", R.drawable.bg_1)
               AllSearchItem(title = "Neer Dosa", type = "Dish", R.drawable.bg_5)
               AllSearchItem(title = "Mysore Sada Dosa", type = "Dish", R.drawable.dosa)
               AllSearchItem(title = "Rava Sada Dosa", type = "Dish", R.drawable.bg_3)
               AllSearchItem(title = "Butter Sada Dosa", type = "Dish", R.drawable.bg_2)
               AllSearchItem(title = "Rava Dosa", type = "Dish", R.drawable.bg_1)
